...
export default function App() {
  ...
  const refreshText = summary?.last_refresh
    ? new Date(summary.last_refresh).toLocaleString()
    : "";

  return (
    <main className="page">
      <header className="topbar easy-topbar">
        <div className="easy-title-wrap">
          <h1>EASY LEAN-Line - {year || "Dashboard"}</h1>
        </div>

        <div className="easy-controls-wrap">
          <div className="easy-controls-row">
            <label className="filter-box date-filter-box">
          ...
          <div className="easy-refresh-row">
            <span className={`status ${dbStatus}`}>PostgreSQL {dbStatus}</span>
